...
class Settings extends Admin_Controller
{
	...
	function index()
	{
		...
		$config['group'] = array(
				...
				'facebook'    => array('name'=>'Facebook Settings','fields'=>'facebook_app_id,facebook_app_secret,activate_facebook'),
		...
		//for facebook api
		  $config['field']['facebook_app_id'] = array('rules'=>'trim|required');
		  $config['field']['facebook_app_secret'] = array('rules'=>'trim|required');
		  $config['field']['activate_facebook'] =array('type'=>'boolean');
		// Display the form
